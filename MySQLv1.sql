...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2016 at 05:50 PM
...
INSERT INTO `orderdetail` (`orderID`, `totalPrice`, `travelDate`, `duration`, `numberOfAdult`, `numberOfChild`, `numberOfInfant`, `numberOfSeniorCitizen`, `packageID`, `listingID`, `customerID`, `totalNumOfPeople`) VALUES
('001A', 72, '2016-07-26', '1 day', NULL, NULL, NULL, NULL, 3, 3, '1', 6),
('001B', 192, '2016-07-27', '1 day', 2, NULL, NULL, NULL, 13, 5, '2', 2);
